...
const FloatingReportButton = () => {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-28 sm:bottom-32 md:bottom-8 right-4 sm:right-6 z-50 w-12 h-12 sm:w-14 sm:h-14 bg-[#D4AF37] hover:bg-[#B8972F] text-[#1A1A1A] rounded-full shadow-xl flex items-center justify-center group transition-all duration-300"
