    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <header className="bg-white border-b border-[#E5E5E5] px-8 py-6">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="font-serif text-3xl text-charcoal">Full Atmosphere Control</h1>
          <p className="text-charcoal/60 mt-2">
            Complete control over your villa's ambiance and lighting scenes.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-8 py-12">
        <div className="bg-white rounded-3xl p-12 border border-[#E5E5E5] shadow-[0_4px_20px_rgba(0,0,0,0.03)] text-center">
          ...
          <p className="text-charcoal/60 max-w-md mx-auto">
            Advanced atmosphere controls including custom scene creation, scheduling, 
            and room-by-room lighting management will be available here.
          </p>
          <Link
            to="/lifestyle-dashboard"
