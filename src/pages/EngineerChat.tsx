...
const EngineerChat = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-white overflow-hidden">
      ...
      {/* Header */}
      <header className="flex-shrink-0 bg-white border-b border-border px-3 sm:px-4 py-2.5 sm:py-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="relative flex-shrink-0">
                <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-moorgen-black flex items-center justify-center text-white font-heading font-semibold text-base sm:text-lg">
                  W
                </div>
      ...
      {/* Chat Messages */}
      <div className="flex-1 overflow-y-auto px-3 sm:px-4 py-4 sm:py-6 bg-gradient-to-b from-white to-muted/10">
          ...
          {messages.map((message) => (
            ...
            >
                {message.sender === "engineer" && (
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-moorgen-black flex items-center justify-center text-white text-[10px] sm:text-xs font-medium flex-shrink-0">
                    W
                  </div>
                )}
                ...
                >
                  <p className="text-[13px] sm:text-sm font-body leading-relaxed">{message.text}</p>
                ...
                {message.sender === "owner" && (
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-champagne-gold to-champagne-gold/80 flex items-center justify-center text-white text-[10px] sm:text-xs font-medium flex-shrink-0">
                    A
                  </div>
                )}
            </div>
      ...
      <div className="flex-shrink-0 bg-white border-t border-border px-3 sm:px-4 py-2.5 sm:py-3 pb-safe">
        <div className="max-w-2xl mx-auto space-y-2 sm:space-y-3">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <motion.button
              ...
              className="p-2 sm:p-2.5 bg-champagne-gold text-white rounded-full hover:bg-champagne-gold/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
            >
