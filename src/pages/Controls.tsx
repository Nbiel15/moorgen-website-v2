          ...
          {devices.map((device) => (
            ...
            >
              ...
              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-5 transition-all duration-300 ${
                device.isOn 
                  ? "bg-accent/20 shadow-[0_0_20px_rgba(212,175,55,0.3)]" 
                  : "bg-primary/5"
              }`}>
                <device.icon className={`w-7 h-7 transition-colors ${
              ...
              <div className={`flex items-center justify-between mt-5 pt-5 border-t ${
                device.isOn ? "border-accent/20" : "border-border"
              }`}>
                <span className={`text-sm font-body tracking-[0.1em] ${
                  device.isOn ? "text-accent font-medium" : "text-muted-foreground"
                }`}>
                  {device.isOn ? "ON" : "OFF"}
                </span>
                <Switch
                  ...
                  className={device.isOn ? "data-[state=checked]:bg-accent" : ""}
                />
              </div>
            </div>
          ))}
